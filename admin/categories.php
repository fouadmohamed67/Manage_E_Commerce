...
if(isset($_SESSION['name']) && $_SESSION['role']==1)
{
            ...
            <div class="card d-flex justify-content-center" >
                            ...
                            foreach($all_categories as $item)
                            {
                              ...
                              <div class="item" id="item<?php echo $item['id']; ?>">
                                ...
                                <span class="visible"><?php if($item['alllow_comment']==1){echo " allowed comments";}else{echo "no comments";} ?></span>
    ...
    else if($do=="addCategory_to_database")
    {
        if($_SERVER['REQUEST_METHOD']=="POST")
        {
            ...
            else
            {
                ...
                ?><script type="text/javascript">goto("categories.php");</script><?php
    ...
    else if($do=="delete")
    {
        if($_SERVER['REQUEST_METHOD']=='POST')
        {
           ...
           ?><script type="text/javascript">goto("categories.php?do=manage");</script><?php
